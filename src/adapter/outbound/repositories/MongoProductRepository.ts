import { CategoryType, Product } from "../../../core/model/entity/Product";
import { IProductRepository } from "../../../core/port/IProductRepository";
import { DBCriteria, DBOperation, DBQuery, IDatabase } from "../database/IDatabase";
import { IProduct } from "../database/mongo/ProductMongoDatabase";
